      ...
      {/* Main Content */}
        <div className="modern-login-content">
          <div className="modern-login-form-container">
            {/* Form Header */}
            <div className="modern-login-form-header">
              <div className="modern-security-message">
                Пожалуйста, подтвердите свою личность для безопасности.
              </div>
            </div>
            
            {/* Form Body */}
            <div className="modern-login-form-body">
              <div className="modern-form-title-section">
                <div className="modern-form-icon"></div>
                <h1 className="modern-form-title">Вход в систему</h1>
              </div>
              ...
              <Form id="sign-in-form" name="sign-in-form">
                <div className="modern-form-field">
                  ...
                  {errors.emailOrUsername && (
                    <div className="modern-field-error">{errors.emailOrUsername}</div>
                  )}
                </div>
                ...
                <div className="modern-form-field">
                  ...
                  />
                  {errors.password && (
                    <div className="modern-field-error">{errors.password}</div>
                  )}
                </div>
        ...
        <div className="modern-login-footer">
          <p className="modern-copyright-text">
            Все права защищены © 2025 Национальный центр повышения квалификации «Өрлеу»
          </p>
          <a href="https://orleu.edu.kz" className="modern-website-link">
            © 2025 — orleu.edu.kz
          </a>
        </div>
